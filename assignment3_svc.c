...
rpc_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case FUNCTION_HOSTNAME:
		_xdr_argument = (xdrproc_t) xdr_void;
		_xdr_result = (xdrproc_t) xdr_wrapstring;
		local = (char *(*)(char *, struct svc_req *)) function_hostname_1_svc;
		break;

	case FUNCTION_MERGESORT:
		_xdr_argument = (xdrproc_t) xdr_mergeIn;
		_xdr_result = (xdrproc_t) xdr_mergeOut;
		local = (char *(*)(char *, struct svc_req *)) function_mergesort_1_svc;
		break;

	case FUNCTION_ENCRYPTEDECHO:
		_xdr_argument = (xdrproc_t) xdr_wrapstring;
		_xdr_result = (xdrproc_t) xdr_wrapstring;
		local = (char *(*)(char *, struct svc_req *)) function_encryptedecho_1_svc;
		break;

	case FUNCTION_LISTFILES:
		_xdr_argument = (xdrproc_t) xdr_wrapstring;
		_xdr_result = (xdrproc_t) xdr_wrapstring;
		local = (char *(*)(char *, struct svc_req *)) function_listfiles_1_svc;
		break;

	case FUNCTION_ADDCOMPLEX:
		_xdr_argument = (xdrproc_t) xdr_addComplex;
		_xdr_result = (xdrproc_t) xdr_complexNum;
		local = (char *(*)(char *, struct svc_req *)) function_addcomplex_1_svc;
		break;
